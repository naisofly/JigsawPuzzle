...
#region "Argument Error Checking"
            ...
            int _NoOfPiecesInRow = 0;
            int _NoOfPiecesInCol = 0;
...
#region "Android File Loading Work"
            ...
            else if (Application.platform == RuntimePlatform.WindowsWebPlayer)
            {
               ...
               StreammingFilePath = Application.streamingAssetsPath.Replace("Raw", "StreamingAssets");
               StreammingFilePath = StreammingFilePath + "/" + Filename;
            ...
            try
            {
                using (bReader = new System.IO.BinaryReader(stream))
                {
                    ...
                    {
                        bReader.Close();
                        Debug.LogError("Error reading file. Make sure this file is created with puzzle maker");
                        return false;
                    }
